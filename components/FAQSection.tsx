...
const faqs = [
  ...
  },
  {
    ...
    answer: 'משך הטיפול משתנה בהתאם לסוג הטיפול ולצרכים האישיים של המטופל. בדרך כלל, טיפול סטנדרטי נמשך בין 45-60 דקות. בטיפול הראשון נערכת הערכה מקיפה שיכולה להימשך מעט יותר זמן (60-75 דקות) כדי להבין את הבעיה ולהתאים תוכנית טיפול אישית. משך הטיפול תלוי גם בחומרת הבעיה ובשיטת הטיפול הנבחרת.',
  },
  {
  ...
  },
  {
    ...
    answer: 'רוב קופות החולים מכסות טיפולי פיזיותרפיה במידה מסוימת, בהתאם לתנאי הביטוח המשלים שלך. הקליניקה עובדת עם קופות החולים השונות ועם ביטוחים פרטיים. מומלץ לבדוק עם הקופה או חברת הביטוח שלך מה התנאים והכיסוי שלך לפני תחילת הטיפול. אנו נשמח לסייע לך לברר את הזכאות שלך ולתאם עם הביטוח שלך.',
  },
]
