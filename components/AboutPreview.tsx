        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div>
            ...
            <p className="text-base sm:text-lg text-gray-700 mb-4 leading-relaxed">
              מכון פיזיותרפיה.פלוס הוקם מתוך חזון לספק טיפול איכותי ומקצועי למטופלים. 
              אנדריי מייזלס, פיזיותרפיסט מקצועי בעל תואר שני ופיזיותרפיסט לשעבר של נבחרת ישראל בג&apos;ודו, מתמחה במגוון רחב של תחומי שיקום וטיפול, תוך הקפדה על גישה אישית ומותאמת לכל מטופל.
            </p>
