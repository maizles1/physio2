...
const insuranceOptions: InsuranceOption[] = [
  {
    ...
    description: 'הקליניקה עובדת עם קופת חולים מאוחדת. ניתן לקבל טיפולי פיזיותרפיה דרך המסלול הפרטי של הקופה.',
    icon: (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {insuranceOptions.map((option, index) => (
              ...
              >
                <div className="mb-3 sm:mb-4 h-20 sm:h-24 md:h-28 flex items-center justify-center relative px-3 sm:px-4 w-full" aria-hidden="true">
