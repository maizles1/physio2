        ...
        <div className="flex min-w-0 items-center justify-between gap-3 py-2.5 sm:py-3 md:py-4">
          ...
          <Link href="/" className="flex shrink-0 items-center gap-3 hover:opacity-90 transition-opacity" aria-label="פיזיותרפיה.פלוס - דף בית">
            ...
            <div className="hidden sm:block">
              <span className="block text-lg font-bold leading-tight text-primary-dark md:text-xl">פיזיותרפיה.פלוס</span>
              <p className="text-xs leading-tight text-primary md:text-sm">מקצוענות שמרגישים בגוף</p>
            </div>
          </Link>

          {/* דסקטופ: שורת ניווט מלאה עם רווחים שווים */}
          <div className="relative z-10 hidden min-h-[48px] min-w-0 flex-1 items-center gap-4 lg:flex xl:gap-5">
            <div className="flex min-w-0 flex-1 flex-nowrap items-center justify-center gap-3 overflow-x-auto overscroll-x-contain px-1 [-ms-overflow-style:none] [scrollbar-width:none] xl:gap-4 [&::-webkit-scrollbar]:hidden">
              {primaryNavigation.map((item) => (
                ...
                >
                  <Link
                    href={item.href}
                    className="flex shrink-0 min-h-[44px] items-center justify-center whitespace-nowrap rounded-lg px-2 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-blue-50 hover:text-[#2080C0] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2080C0]/60 xl:px-3"
            ...
            <div className="flex shrink-0 items-center gap-2 bg-white ps-1 xl:gap-3">
              <a
                ...
                className="btn shrink-0 whitespace-nowrap bg-[#25D366] text-sm text-white hover:bg-[#20BA5A]"
              ...
              {seoConfig.contact.email && (
                <a
                  ...
                  className="btn shrink-0 whitespace-nowrap bg-gray-600 text-sm text-white hover:bg-gray-700"
