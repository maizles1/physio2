...
import { getTopManualReviews, manualReviews, type ManualReview } from '@/config/manual-reviews.config'
...
export default function TestimonialsPreview() {
  const topReviews = getTopManualReviews(3)
  const testimonials = topReviews.length > 0 ? topReviews : fallbackTestimonials
  const reviewCount = manualReviews.length
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
            {reviewCount > 0 && (
              <span className="inline-flex items-center gap-1.5 font-medium text-gray-800 mb-2 block">
