    ...
    <footer className="bg-white text-gray-900 border-t border-gray-200">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-gray-900">אודות הקליניקה</h3>
            <p className="text-gray-700 mb-4 leading-relaxed">
              פיזיותרפיה.פלוס - קליניקת פיזיותרפיה מקצועית המתמחה בטיפול אישי ומותאם לכל מטופל. 
              אנו מתחייבים לספק טיפול איכותי ומקצועי לשיפור איכות החיים.
            </p>
            <div className="flex gap-3 mt-4">
              <a href="#" className="w-10 h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity" style={{ background: '#2080C0' }}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="#" className="w-10 h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity" style={{ background: '#40C0F0' }}>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-gray-700 hover:text-[#2080C0] transition-colors font-medium">
                  דף בית
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-gray-700 hover:text-[#2080C0] transition-colors font-medium">
                  אודות הקליניקה
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-700 hover:text-[#2080C0] transition-colors font-medium">
                  השירותים שלנו
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/faq" className="text-gray-700 hover:text-[#2080C0] transition-colors font-medium">
                  שאלות נפוצות
                </Link>
              </li>
            </ul>
          ...
          {/* Contact Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-gray-900">יצירת קשר</h3>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 text-sm font-medium">
            © {new Date().getFullYear()} פיזיותרפיה.פלוס. כל הזכויות שמורות.
          </p>
          <div className="flex gap-6 text-sm">
            <Link href="/accessibility" className="text-gray-700 hover:text-[#2080C0] transition-colors font-medium">
              הצהרת נגישות
            </Link>
            <Link href="/privacy" className="text-gray-700 hover:text-[#2080C0] transition-colors font-medium">
              מדיניות פרטיות
            </Link>
            <Link href="/terms" className="text-gray-700 hover:text-[#2080C0] transition-colors font-medium">
              תנאי שימוש
            </Link>
          </div>
        </div>
