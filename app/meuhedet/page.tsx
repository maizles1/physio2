...
const faqs = [
  ...
  },
  {
    ...
    a: 'גובה ההשתתפות העצמית נקבע על ידי מאוחדת ועשוי להשתנות בהתאם לסוג ההפניה, רובד ההצטרפות (מאוחדת זהב/שיא) והתעריפים העדכניים. נשמח לעדכן אתכם בפרטים המדויקים בעת תיאום התור.',
  },
  {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-700">
                ממלאים פרטים קצרים – ונחזור אליכם בהקדם לתיאום טיפול במסגרת מאוחדת.
              </p>
            </div>
            <MeuhedetLeadForm />
          </div>
