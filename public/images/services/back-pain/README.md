# 📸 העלאת תמונה לשירות: טיפול בכאבי גב

## 🎯 מיקום העלאה

**תיקייה:** `public/images/services/back-pain/`
...
1. פתח Finder
2. לחץ `Cmd+Shift+G`
3. הדבק: `/Users/andrey/Documents/physio2/public/images/services/back-pain/`
4. העתק את התמונה ושנה את השם ל: `service-image.jpg`

### דרך Cursor/VS Code
1. פתח את התיקייה `public/images/services/back-pain/` בפרויקט
...
3. התמונה אמורה להופיע ליד "טיפול בכאבי גב"

---

## 💡 טיפים

- בחר תמונה שמתאימה לשירות (למשל: תמונת גב, תרגילי פיזיותרפיה)
