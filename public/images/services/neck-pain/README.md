# 📸 העלאת תמונה לשירות: טיפול בכאבי צוואר

## 🎯 מיקום העלאה

**תיקייה:** `public/images/services/neck-pain/`
...
1. פתח Finder
2. לחץ `Cmd+Shift+G`
3. הדבק: `/Users/andrey/Documents/physio2/public/images/services/neck-pain/`
4. העתק את התמונה ושנה את השם ל: `service-image.jpg`

### דרך Cursor/VS Code
1. פתח את התיקייה `public/images/services/neck-pain/` בפרויקט
...
3. התמונה אמורה להופיע ליד "טיפול בכאבי צוואר"

---

## 💡 טיפים

- בחר תמונה שמתאימה לשירות (למשל: תמונת צוואר, תרגילי פיזיותרפיה)
