# 📸 העלאת תמונה לשירות: טיפול במפרק הלסת (TMJ)

## 🎯 מיקום העלאה

**תיקייה:** `public/images/services/tmj/`
...
1. פתח Finder
2. לחץ `Cmd+Shift+G`
3. הדבק: `/Users/andrey/Documents/physio2/public/images/services/tmj/`
4. העתק את התמונה ושנה את השם ל: `service-image.jpg`

### דרך Cursor/VS Code
1. פתח את התיקייה `public/images/services/tmj/` בפרויקט
...
3. התמונה אמורה להופיע ליד "טיפול במפרק הלסת (TMJ)"

---

## 💡 טיפים

- בחר תמונה שמתאימה לשירות (למשל: תמונת לסת, תרגילי פיזיותרפיה ל-TMJ)
