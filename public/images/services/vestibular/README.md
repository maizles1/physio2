# 📸 העלאת תמונה לשירות: שיקום וסטיבולרי - טיפול בסחרחורות

## 🎯 מיקום העלאה

**תיקייה:** `public/images/services/vestibular/`
...
- **שם קובץ**: חייב להיות בדיוק `service-image.jpg`
...
1. פתח Finder
2. לחץ `Cmd+Shift+G`
3. הדבק: `/Users/andrey/Documents/physio2/public/images/services/vestibular/`
4. העתק את התמונה ושנה את השם ל: `service-image.jpg`

### דרך Cursor/VS Code
1. פתח את התיקייה `public/images/services/vestibular/` בפרויקט
...
3. התמונה אמורה להופיע ליד "שיקום וסטיבולרי - טיפול בסחרחורות"

---

## 💡 טיפים

- בחר תמונה שמתאימה לשירות (למשל: תרגילי שיווי משקל, טיפול בסחרחורות)
